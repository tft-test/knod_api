 ...
 */
final class Version20220610095042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `event_evaluations` (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, event_id INT NOT NULL, nb_star INT NOT NULL, INDEX IDX_90FBBA9DA76ED395 (user_id), INDEX IDX_90FBBA9D71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `event_taxonomies` (id INT AUTO_INCREMENT NOT NULL, taxonomy_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_7BC559D69557E6F6 (taxonomy_id), INDEX IDX_7BC559D671F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE favorite_event_categories (id INT AUTO_INCREMENT NOT NULL, event_category_id INT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_2EF1E642B9CF4E62 (event_category_id), INDEX IDX_2EF1E642A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `favorite_events` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_6F323BB0A76ED395 (user_id), INDEX IDX_6F323BB071F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `notification_types` (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_9F846CC9F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `users` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, phone_number VARCHAR(14) NOT NULL, is_verified TINYINT(1) DEFAULT 0 NOT NULL, provider_id VARCHAR(255) DEFAULT NULL, provider_name VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, discr VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `event_taxonomies` ADD CONSTRAINT FK_7BC559D671F7E88B FOREIGN KEY (event_id) REFERENCES `events` (id)');
        ...
        $this->addSql('ALTER TABLE `subscribers` ADD CONSTRAINT FK_2FCD16AC71F7E88B FOREIGN KEY (event_id) REFERENCES `events` (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favorite_event_categories DROP FOREIGN KEY FK_2EF1E642B9CF4E62');
        $this->addSql('ALTER TABLE `event_evaluations` DROP FOREIGN KEY FK_90FBBA9D71F7E88B');
        $this->addSql('ALTER TABLE `event_taxonomies` DROP FOREIGN KEY FK_7BC559D671F7E88B');
        $this->addSql('ALTER TABLE `favorite_events` DROP FOREIGN KEY FK_6F323BB071F7E88B');
        $this->addSql('ALTER TABLE `subscribers` DROP FOREIGN KEY FK_2FCD16AC71F7E88B');
        ...
        $this->addSql('DROP TABLE `event_evaluations`');
        $this->addSql('DROP TABLE `event_taxonomies`');
        $this->addSql('DROP TABLE `events`');
        $this->addSql('DROP TABLE `faqs`');
        $this->addSql('DROP TABLE favorite_event_categories');
